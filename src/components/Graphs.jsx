                  ...
                  <div className="card-body-2 p-0">
                    <ul className="list-group hour-list">
                      ...
                      <li className="list-group-item d-flex justify-content-between align-items-center">
                        11 PM
                        <span className="deg">
                          <i className="bi bi-brightness-high-fill"></i> 31&deg;C
                        </span>
                      </li>
                      <li className="list-group-item d-flex justify-content-between align-items-center">
                        12 PM
                        <span className="deg">
                          <i className="bi bi-brightness-high-fill"></i> 30&deg;C
                        </span>
                      </li>
                      <li className="list-group-item d-flex justify-content-between align-items-center">
                        01 AM
                        <span className="deg">
                          <i className="bi bi-brightness-high-fill"></i> 29&deg;C
                        </span>
                      </li>
                      <li className="list-group-item d-flex justify-content-between align-items-center">
                        02 AM
                        <span className="deg">
                          <i className="bi bi-brightness-high-fill"></i> 28&deg;C
                        </span>
                      </li>
                      <li className="list-group-item d-flex justify-content-between align-items-center">
                        03 AM
                        <span className="deg">
                          <i className="bi bi-brightness-high-fill"></i> 27&deg;C
                        </span>
                      </li>
                      <li className="list-group-item d-flex justify-content-between align-items-center">
                        04 AM
                        <span className="deg">
                          <i className="bi bi-brightness-high-fill"></i> 26&deg;C
                        </span>
                      </li>
                    </ul>
                  </div>
